...
void BaseMesh::SendTessellationData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void BaseMesh::Rotate(float radians_x, float radians_y, float radians_z)
{
	XMMatrixRotationRollPitchYaw(radians_x, radians_y, radians_z);
}
