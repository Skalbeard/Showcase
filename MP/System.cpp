...
System::System()
{
	...
	m_Game = new Game(m_hinstance, m_hwnd, screenWidth, screenHeight, &m_Input);
}
...
void System::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	else
	{
		...
		posX = 15; // (GetSystemMetrics(SM_CXSCREEN) - screenWidth) / 2;
		posY = 15; // (GetSystemMetrics(SM_CYSCREEN) - screenHeight) / 2;
	}
